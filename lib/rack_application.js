...
(function() {
  var RackApplication, async, basename, bufferLines, fs, join, nack, pause, resolve, sourceScriptEnv, _ref, _ref1;
  ...
  _ref1 = require("path"), join = _ref1.join, basename = _ref1.basename, resolve = _ref1.resolve;
  ...
  module.exports = RackApplication = (function() {
    ...
    RackApplication.prototype.setPoolRunOnceFlag = function(callback) {
      ...
      if (!this.statCallbacks.length) {
        fs.exists(join(this.root, "tmp/always_restart.txt"), function(alwaysRestart) {
    ...
    RackApplication.prototype.loadRvmEnvironment = function(env, callback) {
      var script,
        _this = this;
      return fs.exists(script = join(this.root, ".rvmrc"), function(rvmrcExists) {
        var rvm;
        if (rvmrcExists) {
