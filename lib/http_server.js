...
(function() {
  var HttpServer, RackApplication, connect, dirname, fs, join, pause, request, url, version, _ref,
  ...
  module.exports = HttpServer = (function(_super) {
    ...
    HttpServer.prototype.handleStaticRequest = function(req, res, next) {
      ...
      handler = (_base = this.staticHandlers)[root] != null ? (_base = this.staticHandlers)[root] : _base[root] = connect["static"](join(root, "public"));
    ...
    HttpServer.prototype.findRackApplication = function(req, res, next) {
      ...
      return fs.exists(join(root, "config.ru"), function(rackConfigExists) {
        ...
        if (rackConfigExists) {
          req.pow.application = (_base = _this.rackApplications)[root] != null ? (_base = _this.rackApplications)[root] : _base[root] = new RackApplication(_this.configuration, root, req.pow.host);
